...
object DocSpec extends Properties("Doc") {
  ...
  property("text append is same as concat of strings") = forAll(posNum[Int], arbitrary[String], arbitrary[String]) {
    (w, s1, s2) =>
  ...
  property("nesting distributes") = forAll(posNum[Int], posNum[Int], arbitrary[Doc], arbitrary[Doc]) {
    (w, w2, doc, doc2) =>
